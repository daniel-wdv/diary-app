...
<!-- ABOUT THE PROJECT -->
## About The Project
This is a simple diary app where you can store your thoughts and save it in realtime.
...
Install Docker and Docker compose on your VM and just do "sudo docker-compose up --build -d" on the terminal inside the directory you want to store the app.
